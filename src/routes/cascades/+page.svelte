      ...
      <div class="space-y-6">
        ...
        >
          ...
          <p class="mt-3 text-secondary">
            ...
            pass one on to someone else. Each cascade creates a ripple effect of kindness through
          ...
          <div class="mt-4 grid gap-3 md:grid-cols-2">
            ...
            >
              ...
              <div class="flex-1">
                ...
                <p class="mt-1 text-sm text-muted">
                  The recipient's excitement is genuinely rewarding (and you might receive one
                  later!)
                </p>
              </div>
            </div>
