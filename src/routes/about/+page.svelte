<svelte:head>
  <title>About · Meeple Cart</title>
  <meta
    name="description"
    content="Learn about Meeple Cart, New Zealand's board game trading platform"
  />
</svelte:head>
  ...
  <section class="px-6 pt-16 sm:px-8">
    <div class="mx-auto max-w-5xl space-y-8">
      ...
      <div class="grid gap-4 sm:grid-cols-2">
        ...
        >
          <h3 class="mb-1 font-semibold text-primary">Help & FAQ</h3>
          <p class="text-sm text-secondary">
            Get answers to common questions about using the platform
          </p>
        </a>
        <a
          href="/guidelines"
      ...
      <div class="rounded-xl border border-subtle bg-surface-panel p-6">
        ...
        <div class="space-y-3 text-secondary">
          ...
          <ul class="ml-6 space-y-1 list-disc">
            ...
            <li>Sell games you no longer play at fair prices</li>
            <li>Participate in Gift Cascades to spread the joy of gaming</li>
            <li>Build trust and reputation within the community</li>
            <li>Connect with local gamers for meetups and trades</li>
          </ul>
        </div>
      </div>
      ...
      <!-- How It Works -->
      <div class="rounded-xl border border-subtle bg-surface-panel p-6">
        <h2 class="mb-4 text-2xl font-bold text-primary">How It Works</h2>
      ...
      <!-- Community Values -->
      <div class="rounded-xl border border-subtle bg-surface-panel p-6">
        <h2 class="mb-4 text-2xl font-bold text-primary">Our Values</h2>
      ...
      <div class="rounded-xl border border-accent bg-accent/5 p-6 text-center">
        ...
        <a
          href="/register"
          class="inline-block rounded-lg border border-emerald-500 bg-emerald-500 px-6 py-3 font-semibold text-surface-body transition hover:bg-emerald-600"
        >
          Create Account
        </a>
      </div>
